...
export const chatbot = async (prompt , language) => {
  try {
    const emailRequest = {
      emailContent:
        prompt + " please help i might get hurt , give me step by step way to save myself make it consise and should contain bullet points only safety is priority. give me appropriate repsone related to india " + "give respone in language "+language ,
      tone: "serious",
    };
