...
export const chatbot = async (prompt , language) => {
  try {
    const emailRequest = {
      emailContent:
        prompt + "please help i might get hurt , give me step by step way to save myself  make it consise and shoud contain bullet points only safety is priority // this is test api and not real sos call give me appropriate repsone india" + "give respone in language"+language ,
      tone: "serious",
    };
